      ...
      >
        <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className="max-w-sm w-full bg-red-500 shadow-lg rounded-lg pointer-events-auto ring-2 ring-black ring-opacity-5 overflow-hidden">
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4 flex-shrink-0 flex">
                    <button
                      type="button"
                      className="bg-red-500 rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      onClick={() => {
                        setShow(false)
                      }}
                    >
